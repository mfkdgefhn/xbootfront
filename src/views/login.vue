  ...
  <Row type="flex"
    ...
    <i-col :xs="{span:22}"
      ...
      <Row class="login-form">
        ...
        <Row type="flex"
             justify="space-between"
             class="code-row-bg other-login">
          <div class="other-way icons">
            其它方式登录
            <div class="other-icon"
                 @click="toGithubLogin">
              <icon scale="1.1"
                    name="brands/github"></icon>
            </div>
            <div class="other-icon"
                 @click="toQQLogin">
      ...
      <Row class="foot">
        ...
        <Row type="flex"
             justify="center"
             class="code-row-bg copyright">
          Copyright © 2018 - Present <a href="http://exrick.cn"
             target="_blank"
             style="margin:0 5px;">Exrick</a> 版权所有
        </Row>
      </Row>
    </i-col>
  </Row>
